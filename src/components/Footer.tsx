      ...
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="mt-12 border-t border-primary-foreground/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex space-x-6">
            <a href="https://www.instagram.com/nutri.natural.products?igsh=MWhnOW1yOHdrejl6Zw==" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/80 hover:text-white transition-colors">
