      ...
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4 lg:grid-cols-5">
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-primary-foreground/80 max-w-sm">
              At NNP Powders, our journey begins with a simple belief: the purest nutrition comes from nature itself. Nature's Nutrition, Simply Powerful.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li className="flex items-center gap-3 text-base text-primary-foreground/80">
                ...
                <span className="break-all">nutrinaturalpowders123@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 border-t border-primary-foreground/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-base text-primary-foreground/80">
            &copy; {new Date().getFullYear()} NNP Powders. All rights reserved.
          </p>
