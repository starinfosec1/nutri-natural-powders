      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            See photos of our factory, our farm partners, and our finished products. Click any image to view it in full size.
          </p>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <Link href="/products" className="group p-8 bg-white rounded-2xl shadow-sm hover:shadow-md transition-all">
              <h3 className="text-xl font-heading font-bold mb-2 group-hover:text-primary transition-colors">View Our Products</h3>
              <p className="text-muted-foreground">Browse our full range of natural powders.</p>
            </Link>
            <Link href="/about" className="group p-8 bg-white rounded-2xl shadow-sm hover:shadow-md transition-all">
              <h3 className="text-xl font-heading font-bold mb-2 group-hover:text-primary transition-colors">About Our Company</h3>
              <p className="text-muted-foreground">Learn about NNP Products and our story.</p>
            </Link>
            <Link href="/contact" className="group p-8 bg-white rounded-2xl shadow-sm hover:shadow-md transition-all">
              ...
              <p className="text-muted-foreground">Get in touch for orders or questions.</p>
            </Link>
          </div>
        </div>
      </div>
